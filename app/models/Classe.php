 ...
 */
	...
	public function tps() {
		return $this->belongsToMany('TP', 'classes_tps', 'classe_id', 'tp_id')->withPivot('poids_local', 'corrige', 'distribue','commentaire_visible'); //encore ici, je suis obligé de spécifier tp_id, sinon, la clé est t_p_id ????
	}
