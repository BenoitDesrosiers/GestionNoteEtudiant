...
<div class="container">
	<section class="section-padding">
		<div class="jumbotron text-left">
			{{ Form::open(['route'=> array('tpsPassation.voirSuiteCorrection' ), 'method' => 'PUT', 'class' => 'form-horizontal form-compact', 'role'=>'form']) }}
				@include('tpsPassation.voirCorrection_subview')
